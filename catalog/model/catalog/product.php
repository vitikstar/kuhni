...
class ModelCatalogProduct extends Model {
	...
	public function getProductComplements($product_id,$type='main')
	{
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_complement WHERE product_id = '" . (int)$product_id . "' AND type='". $type ."' ORDER BY sort_order ASC");
